...
namespace Infrastructure.Persistence.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()")
                    // xmin не объявляем (системная колонка), EF читает её напрямую
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "ix_punishments_user_guild",
                table: "punishments",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "eligible_users_snapshot");
            migrationBuilder.DropTable(name: "roulette_rounds");
            migrationBuilder.DropTable(name: "bot_jobs");
            migrationBuilder.DropTable(name: "ticket_transfers");
            migrationBuilder.DropTable(name: "punishment_history");
            migrationBuilder.DropTable(name: "punishments");
